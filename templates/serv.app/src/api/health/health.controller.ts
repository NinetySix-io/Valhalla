...
import { SITES_SERVICE_NAME, protobufPackage } from '@app/protobuf';
...
export class HealthController {
  ...
  private checkGrpc(): HealthIndicatorFunction {
    return () =>
      this.grpc.checkService<GrpcOptions>(SITES_SERVICE_NAME, protobufPackage, {
        package: protobufPackage,
        healthServiceName: SITES_SERVICE_NAME,
