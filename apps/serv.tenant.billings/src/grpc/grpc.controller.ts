...
import { CreateTenantPlanCommand } from '@app/cqrs/commands/create.tenant.plan.command';
import { CreateTenantSubscriptionCommand } from '@app/cqrs/commands/create.tenant.subscription.command';
import { DeleteTenantPlanCommand } from '@app/cqrs/commands/delete.tenant.plan.command';
import { DeleteTenantSubscriptionCommand } from '@app/cqrs/commands/delete.tenant.subscription.command';
import { GetTenantInvoiceQuery } from '@app/cqrs/queries/get.tenant.invoice.query';
import { GetTenantPlanQuery } from '@app/cqrs/queries/get.tenant.plan.query';
import { GetTenantSubscriptionQuery } from '@app/cqrs/queries/get.tenant.subscription.query';
import { GrpcClass } from '@valhalla/serv.core';
import { Observable } from 'rxjs';
import { UpdateTenantPlanCommand } from '@app/cqrs/commands/update.tenant.plan.command';
import { UpdateTenantSubscriptionCommand } from '@app/cqrs/commands/update.tenant.subscription.command';

@Controller()
@GrpcClass(TENANT_BILLINGS_SERVICE_NAME)
export class gRpcController implements TenantBillingsServiceController {
  constructor(
