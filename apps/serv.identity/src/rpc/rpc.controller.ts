...
import { AccountLoginCommand } from '@app/rpc/commands/account.login.command';
import { AccountLogoutCommand } from './commands/account.logout.command';
import { AccountRegisterCommand } from './commands/account.register.command';
import { Controller } from '@nestjs/common';
import { CreateAccessCommand } from './commands/create.access.command';
...
import { ForgotAccountPasswordCommand } from '@app/rpc/commands/forgot.account.password.command';
import { GrpcClass } from '@valhalla/serv.core';
import { Observable } from 'rxjs';
import { ProvisionAccessTokenCommand } from './commands/provision.access.token.command';
import { SendAccountEmailVerificationCommand } from '@app/rpc/commands/send.account.email.verification.command';
import { UpdateAccountCommand } from '@app/rpc/commands/update.account.command';
import { UpdateAccountPasswordCommand } from '@app/rpc/commands/update.account.password.command';
import { VerifyAccountEmailCommand } from '@app/rpc/commands/verify.account.email.command';

@Controller()
@GrpcClass(IDENTITY_SERVICE_NAME)
export class RpcController implements IdentityServiceController {
  constructor(
